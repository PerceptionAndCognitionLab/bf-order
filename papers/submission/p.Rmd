...
- The data analyzed here were previously collected by @Teige-Mocigemba:etal:2017 (Example 1) and @Rouder:etal:2005a (Example 2). Both datasets are publicly available on github.com ([Example 1](https://github.com/PerceptionAndCognitionLab/bf-order/blob/public/papers/submission/dat/AMP_end_all_final.sav?raw=true) and [Example 2](https://raw.githubusercontent.com/PerceptionCognitionLab/data0/master/lexDec-dist5/ld5.all)).
