...
```{r constraint, cache = T, fig.cap= "The three models are shown as bivariate distributions across two individuals' true values (denoted $\\theta_1$ and $\\theta_2$).  Darker areas show greater concentration of density.", fig.height=3, fig.width=9}
